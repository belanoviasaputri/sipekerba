...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <!-- Tabel pengaduan: Belum Diproses -->
    <div class="card">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-hover" id="table" width="100%">
            ...
            <tbody align="center">
              <?php
              // Menampilkan data pengaduan yang statusnya 'Sedang diajukan'
    ...
    <!-- Tabel pengaduan: Sedang Diproses -->
    <div class="card">
      <div class="card-header">
      ...
      <div class="card-body">
        <div class="table">
          <table class="table-hover" id="table2" width="100%">
            ...
            <tbody align="center">
              <?php
              // Menampilkan data pengaduan yang statusnya 'Sedang diproses'
    ...
    <!-- Tabel pengaduan: Telah Diproses -->
      ...
      <div class="card-body">
        <div class="table">
          <table class="table-hover" id="table3" width="100%">
            ...
            <tbody align="center">
              <?php
              // Menampilkan data pengaduan yang statusnya 'Selesai diproses'
