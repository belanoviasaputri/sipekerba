...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
          <!-- Form update status dan catatan pengaduan -->
          <form action="" method="POST">
            <div class="col-md-12">
              ...
              <!-- Bagian identitas pelapor dan barang sudah ditampilkan di tabel utama, tidak perlu diulang di detail -->
              <div class="row">
                <div class="col-md-4" style="border: 1px solid #ced4da; border-radius: 5px; margin: 7px 7px; padding: 7px 10px;">
                  <p><b>Status :</b></p>
                  <?php
                  // Menampilkan radio button status sesuai status pengaduan
