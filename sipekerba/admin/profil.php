<?php
// Memasukkan file header dan sidebar pengaturan akun
include "templates/header.php";
include "templates/sidebar-atur-akun.php";
$id = $_SESSION['login']['user_id'];

// Mengambil data user berdasarkan user_id yang sedang login
$data = query("SELECT * FROM user WHERE user_id = '$id'")[0];

// Proses update foto profil jika form disubmit
