<?php
// Memasukkan file header dan sidebar report khusus halaman report bulanan
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-hover" id="table-report" width="100%">
            ...
            <tbody align="center">
              <?php
              // Menampilkan data pengaduan berdasarkan bulan dan tahun yang dipilih
              $month = $_POST['month'];
              $year = $_POST['year'];
