<?php
// Memasukkan file header dan sidebar report khusus halaman report tahunan
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-hover" id="table-report" width="100%">
            ...
            <tbody align="center">
              <?php
              // Menampilkan data pengaduan berdasarkan rentang tahun yang dipilih
              $year1 = $_POST['year1'];
              $year2 = $_POST['year2'];
