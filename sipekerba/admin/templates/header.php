...
<head>
  ...
  <title>SINTAK</title>
  <link rel="icon" href="../assets/img/ini.jpg">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <img src="../assets/img/ini.jpg" alt="SINTAK" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light" style="font-size: 19px;">SINTAK</span>
      </a>
