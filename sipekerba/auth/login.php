...
<body>
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6">
                <a class="btn logo" href="../index.php">SINTAK</a>
                <img src="../assets/img/ini.jpg" width="40" height="40">
                <p class="lead">Sistem Informasi Tanggap Kerusakan</p>
                ...
                <br>
                <center>
                    <p>Repost by <a href='https://sharecodingan.blogspot.com/' title='sharecodingan.blogspot.com' target='_blank'>ShareCodingan</a></p>
                </center>
